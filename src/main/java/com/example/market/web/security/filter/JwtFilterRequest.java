...
@Component
public class JwtFilterRequest extends OncePerRequestFilter { //Para filtrar la petición y saber si en el encabezado viene un token y ese
                                                            //token es correcto
    @Autowired
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer")) {
            ...
            if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                UserDetails userDetails = dataUserDetailService.loadUserByUsername(username);
